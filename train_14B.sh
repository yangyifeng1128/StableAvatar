...
accelerate launch --config_file accelerate_config/accelerate_config_machine_14B_multiple.yaml --machine_rank ${NODE_RANK} --main_process_ip ${MASTER_ADDR} --main_process_port ${MASTER_PORT} train_14B.py \
  ...
  --learning_rate=1e-04 \
  --seed=42 \
  --output_dir="/root/autodl-tmp/StableAvatar/output_14B_dir_64" \
