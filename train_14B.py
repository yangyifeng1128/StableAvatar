...
def main():
    ...
    transformer3d, optimizer, train_rec_dataloader, train_square_dataloader, train_vec_dataloader, lr_scheduler = accelerator.prepare(transformer3d, optimizer, train_rec_dataloader, train_square_dataloader, train_vec_dataloader, lr_scheduler)
